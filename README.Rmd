...
```{r, echo=FALSE}
# tidygate_env$select_data |> readr::write_csv("data/interactive_gating_demo_select_data.csv")
# tidygate_env$brush_data |> readr::write_csv("data/interactive_gating_demo_brush_data.csv")
 
# Load pre-recorded brush path from data for example
tidygate_env <<- rlang::env()
tidygate_env$select_data <- readr::read_csv("data/interactive_gating_demo_select_data.csv")
tidygate_env$brush_data <- readr::read_csv("data/interactive_gating_demo_brush_data.csv")
