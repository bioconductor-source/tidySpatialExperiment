...
![plotly demonstration](../man/figures/plotly_demo.png)
...
![tidygate demonstration](../man/figures/tidygate_demo.gif)
...
data("demo_select_data", package = "tidySpatialExperiment")
...
A record of which points appear in which gates is appended to the SpatialExperiment object in the `.gate_interactive` column. To select cells which appear within any gates, filter for non-empty strings. To select cells which appear within a specific gate, string pattern matching can be used.
